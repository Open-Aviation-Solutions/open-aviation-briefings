...
header: Circuit Introduction — Pre-flight Brief
---
...
_CASA Recreational Pilot License (Aeroplane) — Lesson 6, Pre-flight Briefing_
...
- The hand-over uses **three calls**:
  1. **"You have control."**
  2. **"I have control."** _(other pilot)_
  3. **"You have control."** _(first pilot confirms)_
