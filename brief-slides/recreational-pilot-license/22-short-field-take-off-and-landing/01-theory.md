...
_CASA Recreational Pilot License (Aeroplane) — CASA Sample Syllabus Lesson 22, Pre-flight theory_
...
<briefing-overview plane-position="0" controls-start>
  ...
  <briefing-topic label="Performance&#10;Factors" time="6"></briefing-topic>
  <briefing-topic label="Planning&#10;the Numbers" time="6"></briefing-topic>
  <briefing-topic label="Short-field&#10;Take-off" time="6"></briefing-topic>
  <briefing-topic label="Short-field&#10;Landing" time="5"></briefing-topic>
  <briefing-topic label="Engine-Failure&#10;Revision" time="3"></briefing-topic>
...
![right large Profile diagram contrasting take-off run with the longer take-off distance over a 50 ft screen, and landing distance over a 50 ft screen with the shorter landing run after touchdown.](/brief-assets/recreational-pilot-license/22-short-field-take-off-and-landing/run-vs-distance-profile.png)
...
![right large Diagram showing a runway with a wind arrow at an angle, resolved into a headwind component along the runway and a crosswind component across it, with the angle between wind and runway marked.](/brief-assets/recreational-pilot-license/22-short-field-take-off-and-landing/wind-component-diagram.png)
...
6. **Best-angle climb ($V_X$)** until the obstacle is cleared
...
- **$V_X$ — best angle:** steepest climb, most height per **distance** → use to clear obstacles
- **$V_Y$ — best rate:** most height per **time** → use once the obstacle is behind you
...
- Hold $V_X$ **only** until the obstacle is cleared, then accelerate to the best-rate climb
...
- **Explain** why we climb at **best angle ($V_X$)**, not best rate, to clear an obstacle
...
| Short-field take-off | All runway, recommended flap, full power then release, lowest safe lift-off, $V_X$ to clear obstacle, then flap up |
...
| Engine failure | Lower the nose **immediately** ($V_X$ is close to the stall); fly a controlled glide; aviate-navigate-communicate |
...
_Bring your aircraft's performance charts and today's forecast — we'll work the real numbers together at the whiteboard._
