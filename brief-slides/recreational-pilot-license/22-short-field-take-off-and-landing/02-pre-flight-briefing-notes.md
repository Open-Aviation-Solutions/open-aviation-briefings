...
_CASA Recreational Pilot License (Aeroplane) — Lesson 22, Pre-flight Briefing Notes_
...
Before the lesson, read the sections that follow, then come back here: note *your* running order and approximate timings, and sketch the whiteboard you'll draw — your aerodrome, the strip and its obstacles, today's weather and wind, and the numbers you've worked. For inspiration, see the [NZ CAA Flight Instructor Guide whiteboard for Short-field take-off and landing](https://www.aviation.govt.nz/assets/licensing-and-certification/flight-instructor-guide/whiteboards/fig-whiteboard-am-sftl.pdf).
...
- Best-angle climb speed $V_X$: ______ &nbsp; Best-rate $V_Y$: ______
- Short-field approach speed: ______ &nbsp; Aim point: ______
- CTAF / frequencies: ______

**Draw** — the **take-off** as a profile: all runway → full power on brakes → lift off → **$V_X$ to the obstacle** → flap up → accelerate to $V_Y$.
...
- All runway · full power · $V_X$ to the obstacle · flap up after
