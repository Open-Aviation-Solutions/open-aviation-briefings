...
_CASA Recreational Pilot License (Aeroplane) — CASA Sample Syllabus Lesson 17, Pre-flight Briefing Notes_
...
The theory session is done and the student knows today involves practising a simulated engine failure — that can raise nerves, so keep it interactive. About **15–20 minutes** at the whiteboard: **ask, draw, and listen** rather than present. The two safety-critical pieces — the **immediate/vital actions** and the **field-selection judgement** — are the heart of this briefing; the student should be able to talk both back to you before you walk to the aircraft.
...
| Immediate/vital actions — rehearse it now | 3–4 min |
...
**Expect** — honest self-assessment. Nerves before an engine-failure lesson are normal.
