...
_CASA Recreational Pilot License (Aeroplane) — Lesson 5, Pre-flight Briefing Notes_
...
Before the lesson, read the sections that follow, then come back here: note *your* running order and approximate timings, and sketch the whiteboard you'll draw — your training area, the safe recovery height, the HASELL check, and the recovery sequence. For inspiration, see the NZ CAA Flight Instructor Guide whiteboards for [Basic stalling](https://www.aviation.govt.nz/assets/licensing-and-certification/flight-instructor-guide/whiteboards/fig-whiteboard-bc-bs.pdf) and [Slow flight](https://www.aviation.govt.nz/assets/licensing-and-certification/flight-instructor-guide/whiteboards/fig-whiteboard-bc-sf.pdf).
...
5. **HASELL → wing-drop / spin avoidance** — **instructor demonstration only**, and **only if the aeroplane is approved for intentional spinning**
...
**Expect** — **reduce AoA first.** Power without easing forward will *not* unstall the wing — this is the one idea to nail.
