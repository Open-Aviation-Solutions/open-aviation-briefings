...
_CASA Recreational Pilot License (Aeroplane) — CASA Sample Syllabus Lesson 24, Pre-flight Briefing Notes_
...
The theory session is done and the student knows today involves practising a simulated precautionary landing — keep it interactive. About **15 minutes** at the whiteboard: **ask, draw, and listen** rather than present. The two safety-critical pieces — **deciding early** and the **inspection pattern** — are the heart of this briefing; the student should be able to talk both back to you before you walk to the aircraft.
...
| Airmanship emphasis — deciding early | 3–4 min |
...
Write the aim on the board — everything else hangs off *decide, search, select, land*.
...
- **Decide early** — while you're still in full control
- Inspect properly — **low pass, climb, circuit, dummy approach** — before you commit
