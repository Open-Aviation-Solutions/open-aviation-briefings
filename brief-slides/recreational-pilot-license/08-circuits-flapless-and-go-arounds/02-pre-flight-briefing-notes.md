...
**Expect** — *Full power → Attitude (arrest descent, climb) → Flap up progressively → Climb and re-trim*, on the extended centreline. If this doesn't come back cleanly, build it on the board now — it's the backbone of the flight.
