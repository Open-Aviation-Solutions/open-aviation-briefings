...
![right large](/brief-assets/recreational-pilot-license/01-effects-of-controls/reddit-hand-wing.png)
...
<youtube-video video-id="sJtgQBZ8d_U" class="right large" />
...
![right drop-shadow](/brief-assets/recreational-pilot-license/01-effects-of-controls/elevator-pitch.gif)

Just like your **hand being pushed up or down** by the airflow as you change the angle of your hand, the elevator causes the **tail of the plane to be pushed up or down** depending on its angle.
...
This **pitches** the aeroplane around the **lateral** axis.
...
<secondary-effect-elevator height="400px"></secondary-effect-elevator>
...
![right drop-shadow](/brief-assets/recreational-pilot-license/01-effects-of-controls/aileron-roll.gif)
...
![right medium drop-shadow](/brief-assets/recreational-pilot-license/01-effects-of-controls/rudder-yaw.gif)
