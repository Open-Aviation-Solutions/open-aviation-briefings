...
const PUBLISHED_COMPONENTS = ['aerofoil-dynamics', 'four-forces', 'briefing-overview', 'climb-performance', 'pitch-roll-yaw', 'circuit-diagram', 'crosswind-clock', 'max-rate-min-radius', 'unusual-attitudes']
